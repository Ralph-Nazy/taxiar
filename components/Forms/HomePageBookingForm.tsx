...
const HomePageBookingForm: NextPage = () => {
  ...
  return (
    <div className="bg-white p-10 shadow-md mb-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          <div>
            <input
              ...
              className="py-3 px-6 text-[12px] mb-2  font-[300] outline-none text-taxiar-3 w-[100%] bg-white border-[1px] border-taxiar-14  focus:border-[1px] focus:ring-0 focus:ring-taxiar-1  focus:border-taxiar-1"
            />
            {errors.name && (
          ...
          <div>
            ...
            />
            {errors.name && (
              <span className="my-2 text-[#dc2626]  font-[300] leading-[20px]">
                This field is required
              </span>
            )}
          </div> 
